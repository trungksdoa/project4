                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                ...
                                <div class="dropdown-item noti-title">
                                    <h5 class="text-overflow">
                                        <small>Hello, <% out.print((session.getAttribute("username"))); %></small>
                                    </h5>
                                </div>
                                <% int dataId = (int) session.getAttribute("idUser");%>
                                <a href="DetailServlet?id=<%= dataId%>" class="dropdown-item notify-item">
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="active">
                                        <a class="active" href="ui-icons.html">Icons</a>
                                    </li>
                                    <li>
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="alert alert-success" role="alert">
                            ...
                            <p><b>Font Awesome</b> has grown to have over 5,000 icons and continues to add the most popular and needed icons. Stop hunting down missing icons you need, combining from multiple sets, or finding that company's official logo in a
                                dirty corner of the internet. Size your icons in relation to your UI. rotate, align, mirror, pull and stack them with ease too thanks to our bundled styling. You can find examples and documentation about Font Awesome here:
                                <a target="_blank" href="https://fontawesome.com/">Font Awesome</a></p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-12 col-lg-12 col-xl-12">
                                <div id="tabs">
                                    ...
                                    <div id="tabs-1">
                                        <p>Proin elit arcu, rutrum commodo, vehicula tempus, commodo a, risus. Curabitur nec arcu. Donec sollicitudin mi sit amet mauris. Nam elementum quam ullamcorper ante. Etiam aliquet massa et lorem. Mauris dapibus lacus
                                            auctor risus. Aenean tempor ullamcorper leo. Vivamus sed magna quis ligula eleifend adipiscing. Duis orci. Aliquam sodales tortor vitae ipsum. Aliquam nulla. Duis aliquam molestie erat. Ut et mauris vel pede varius
